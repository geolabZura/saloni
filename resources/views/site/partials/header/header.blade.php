<header class="HeaderMain PageHeight" id="HeaderID">
    <div class="container-fluid Filter " id="navbar">
        <div class="row">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 LogoWrapper">
                        <svg class="HeaderLogo" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
